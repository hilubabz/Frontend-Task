...
import { formInput } from "./services/form.zod";
    ...
    <div className="flex justify-center pt-20">
      ...
      >
        <div className="mb-4">
          ...
          <br />
          <input {...register("name")} className="border-1 h-10 w-[500px] p-2" />
          <br />
          {errors?.name && (
        ...
        <div className="mb-4">
          ...
          <br />
          <input {...register("email")} className="border-1 p-2 h-10 w-[500px]" />
          <br />
          {errors?.email && (
        ...
        <div className="mb-4">
          ...
          <br />
          <input {...register("message")} className="border-1 p-2 h-10 w-[500px]" />
          <br />
          {errors?.message && (
            <div className="text-red-700 text-lg">{errors.message.message}</div>
          )}
        </div>
